...
plant: drawplant.cpp drawplant.h plant.cpp readppm.cpp helper.cpp helper.h lsystem.cpp lsystem.h
	${CC} ${CFLAGS} ${INCLUDE} -o plant ${LIBDIR} drawplant.cpp plant.cpp readppm.cpp helper.cpp helper.h lsystem.cpp lsystem.h ${LIBS}
